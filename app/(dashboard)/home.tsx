...
const JournalEntryItem: React.FC<{ entry: JournalEntry }> = ({ entry }) => {
  ...
  return (
    <TouchableOpacity
      className="flex-row items-center justify-between p-3 bg-white border border-gray-200 rounded-lg mb-2"
            ...
            >
              {moodOptions.map((mood) => (
                <TouchableOpacity
                  ...
                  className={`flex-col items-center justify-center h-24 rounded-xl p-3
